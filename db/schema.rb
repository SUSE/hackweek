...
ActiveRecord::Schema.define(version: 20_180_820_211_721) do
  ...
  create_table 'crono_jobs', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.text 'log', limit: 4_294_967_295
  ...
  create_table 'episodes_projects', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    ...
    t.index %w[episode_id project_id], name: 'index_episodes_projects_on_episode_id_and_project_id', unique: true
